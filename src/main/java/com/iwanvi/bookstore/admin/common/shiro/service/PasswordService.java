package com.iwanvi.bookstore.admin.common.shiro.service;

import com.iwanvi.bookstore.admin.common.constant.Constants;
import com.iwanvi.bookstore.admin.common.exception.user.UserPasswordNotMatchException;
import com.iwanvi.bookstore.admin.common.exception.user.UserPasswordRetryLimitExceedException;
...
public class PasswordService {
	...
	public static void main(String[] args) {
		...
		System.out.println(new PasswordService().encryptPassword("iwanvi", "123456", "222222"));
	}
}
