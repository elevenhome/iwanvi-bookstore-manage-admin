...
/**
 * 业务书单表 professional_book
 * @author iwanvi
 * @date 2019-04-03
 */
public class ProfessionalBook extends BaseEntity{
	...
	public void setWeekPv(String weekPv) {
		this.weekPv = weekPv;
	}

	public BookCenter getBook() {
		return book;
	}

	public void setBook(BookCenter book) {
		this.book = book;
	}
	...
	public void setBookListIds(String bookListIds) {
